<h1 id="duplexer2-build-status-https-travis-ci-org-deoxxa-duplexer2-png-https-travis-ci-org-deoxxa-fork-">duplexer2 <a href="https://travis-ci.org/deoxxa/fork"><img src="https://travis-ci.org/deoxxa/duplexer2.png" alt="build status"></a></h1>
<p>Like duplexer (<a href="http://npm.im/duplexer">http://npm.im/duplexer</a>) but using streams2.</p>
<h2 id="overview">Overview</h2>
<p>duplexer2 is a reimplementation of <a href="http://npm.im/duplexer">duplexer</a> using the
readable-stream API which is standard in node as of v0.10. Everything largely
works the same.</p>
<h2 id="installation">Installation</h2>
<p>Available via <a href="http://npmjs.org/">npm</a>:</p>
<blockquote>
...
<pre><code class="lang-javascript">duplexer2([options], writable, readable)
</code></pre>
<pre><code class="lang-javascript">var duplex = duplexer2(new stream.Writable(), new stream.Readable());
</code></pre>
<p>Arguments</p>
<ul>
...
<p>Also see <a href="https://github.com/deoxxa/duplexer2/blob/master/example.js">example.js</a>.</p>
<p>Code:</p>
...
<p>3-clause BSD. A copy is included with the source.</p>
