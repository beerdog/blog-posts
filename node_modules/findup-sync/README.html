<h1 id="findup-sync-build-status-https-travis-ci-org-js-cli-node-findup-sync-svg-https-travis-ci-org-js-cli-node-findup-sync-npm-version-https-badge-fury-io-js-findup-sync-svg-http-badge-fury-io-js-findup-sync-">findup-sync  <a href="https://travis-ci.org/js-cli/node-findup-sync"><img src="https://travis-ci.org/js-cli/node-findup-sync.svg" alt="Build Status"></a>  <a href="http://badge.fury.io/js/findup-sync"><img src="https://badge.fury.io/js/findup-sync.svg" alt="NPM version"></a></h1>
<blockquote>
...
<pre><code class="lang-bash">npm i findup-sync --save
</code></pre>
<h2 id="usage">Usage</h2>
<pre><code class="lang-js">var findup = require(&#39;findup-sync&#39;);
...
<p>2015-01-30 - v0.4.0 - Refactored, not also uses <a href="http://github.com/jonschlinkert/micromatch">micromatch</a> instead of minimatch.<br>2015-09-14 - v0.3.0 - updated glob to ~5.0.<br>2014-12-17 - v0.2.1 - Updated to glob 4.3.<br>2014-12-16 - v0.2.0 - Removed lodash, updated to glob 4.x.<br>2014-03-14 - v0.1.3 - Updated dependencies.<br>2013-03-08 - v0.1.2 - Updated dependencies. Fixed a Node 0.9.x bug. Updated unit tests to work cross-platform.<br>2012-11-15 - v0.1.1 - Now works without an options object.<br>2012-11-01 - v0.1.0 - Initial release.  </p>
...
<p>Copyright (c) 2012-2016 &quot;Cowboy&quot; Ben Alman<br>Released under the MIT license</p>
