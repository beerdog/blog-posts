<h1 id="normalize-package-data-build-status-https-travis-ci-org-npm-normalize-package-data-png-branch-master-https-travis-ci-org-npm-normalize-package-data-">normalize-package-data <a href="https://travis-ci.org/npm/normalize-package-data"><img src="https://travis-ci.org/npm/normalize-package-data.png?branch=master" alt="Build Status"></a></h1>
...
<pre><code class="lang-javascript">normalizeData = require(&#39;normalize-package-data&#39;)
...
<p>normalize-package-data is released under the <a href="http://opensource.org/licenses/MIT">BSD 2-Clause License</a>.<br>Copyright (c) 2013 Meryn Stol  </p>
