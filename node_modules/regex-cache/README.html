...
<pre><code class="lang-sh">$ npm install regex-cache --save
</code></pre>
<ul>
...
<pre><code class="lang-js">var cache = require(&#39;regex-cache&#39;);
...
<h3 id="use-this-when-">Use this when...</h3>
<ul>
...
<h3 id="do-not-use-this-when-">Do not use this when...</h3>
<ul>
...
<pre><code class="lang-bash"># no args passed (defaults)
...
<pre><code class="lang-bash">npm i -d &amp;&amp; npm run benchmarks
</code></pre>
...
<p>Pull requests and stars are always welcome. For bugs and feature requests, <a href="https://github.com/jonschlinkert/regex-cache/issues/new">please create an issue</a>.</p>
