<h1 id="unc-path-regex-npm-version-https-badge-fury-io-js-unc-path-regex-svg-http-badge-fury-io-js-unc-path-regex-build-status-https-travis-ci-org-jonschlinkert-unc-path-regex-svg-https-travis-ci-org-jonschlinkert-unc-path-regex-">unc-path-regex <a href="http://badge.fury.io/js/unc-path-regex"><img src="https://badge.fury.io/js/unc-path-regex.svg" alt="NPM version"></a>  <a href="https://travis-ci.org/jonschlinkert/unc-path-regex"><img src="https://travis-ci.org/jonschlinkert/unc-path-regex.svg" alt="Build Status"></a></h1>
<blockquote>
...
<pre><code class="lang-sh">$ npm i unc-path-regex --save
</code></pre>
<h2 id="usage">Usage</h2>
<pre><code class="lang-js">// unc-path-regex returns a function
var regex = require(&#39;unc-path-regex&#39;)();
</code></pre>
<p><strong>true</strong></p>
<p>Returns true for windows UNC paths:</p>
<pre><code class="lang-js">regex.test(&#39;\\/foo/bar&#39;);
regex.test(&#39;\\\\foo/bar&#39;);
