...
<pre><code class="lang-javascript">var gutil = require(&#39;gulp-util&#39;);
...
<h3 id="replaceextension-path-newextension-">replaceExtension(path, newExtension)</h3>
<p>Replaces a file extension in a path. Returns the new path.</p>
<h3 id="isstream-obj-">isStream(obj)</h3>
<p>Returns true or false if an object is a stream.</p>
<h3 id="isbuffer-obj-">isBuffer(obj)</h3>
<p>Returns true or false if an object is a Buffer.</p>
<h3 id="template-string-data-">template(string[, data])</h3>
...
<h2 id="new-file-obj-">new File(obj)</h2>
<p>This is just <a href="https://github.com/wearefractal/vinyl">vinyl</a></p>
<pre><code class="lang-javascript">var file = new gutil.File({
...
<pre><code class="lang-javascript">// gulp should be called like this :
...
<pre><code class="lang-javascript">gulp.src(&#39;stuff/*.js&#39;)
  .pipe(gutil.buffer(function(err, files) {

  }));
</code></pre>
<h2 id="new-pluginerror-pluginname-message-options-">new PluginError(pluginName, message[, options])</h2>
<ul>
...
<pre><code class="lang-javascript">var err = new gutil.PluginError(&#39;test&#39;, {
