...
<p><a href="https://travis-ci.org/undertakerjs/glogg"><img src="https://img.shields.io/travis/undertakerjs/glogg/master.svg?label=travis&amp;style=flat-square" alt="Travis Build Status"></a></p>
<p>Global logging utility</p>
<h2 id="usage">Usage</h2>
<pre><code class="lang-js">var getLogger = require(&#39;glogg&#39;);
...
<h3 id="getlogger-namespace-">getLogger([namespace])</h3>
...
be emitted.</p>
<h4 id="logger-debug-msg-">logger.debug(msg)</h4>
...
<h4 id="logger-info-msg-">logger.info(msg)</h4>
<p>Emits a <code>info</code> event with the given <code>msg</code>.</p>
<p>If the first argument is a string, all arguments are passed to node&#39;s
<code>util.format()</code> before being emitted.</p>
<h4 id="logger-warn-msg-">logger.warn(msg)</h4>
<p>Emits a <code>warn</code> event with the given <code>msg</code>.</p>
<p>If the first argument is a string, all arguments are passed to node&#39;s
<code>util.format()</code> before being emitted.</p>
<h4 id="logger-error-msg-">logger.error(msg)</h4>
...
<h4 id="logger-on-event-fn-">logger.on(event, fn)</h4>
