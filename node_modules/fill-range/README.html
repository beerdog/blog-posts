<h1 id="fill-range-npm-version-https-badge-fury-io-js-fill-range-svg-http-badge-fury-io-js-fill-range-build-status-https-travis-ci-org-jonschlinkert-fill-range-svg-https-travis-ci-org-jonschlinkert-fill-range-">fill-range <a href="http://badge.fury.io/js/fill-range"><img src="https://badge.fury.io/js/fill-range.svg" alt="NPM version"></a>  <a href="https://travis-ci.org/jonschlinkert/fill-range"><img src="https://travis-ci.org/jonschlinkert/fill-range.svg" alt="Build Status"></a></h1>
<blockquote>
<p>Fill in a range of numbers or letters, optionally passing an increment or multiplier to use.</p>
</blockquote>
<h2 id="install-with-npm-npmjs-org-">Install with <a href="npmjs.org">npm</a></h2>
<pre><code class="lang-bash">npm i fill-range --save
</code></pre>
<!-- toc -->
<ul>
...
<pre><code class="lang-js">var range = require(&#39;fill-range&#39;);

range(&#39;a&#39;, &#39;e&#39;);
//=&gt; [&#39;a&#39;, &#39;b&#39;, &#39;c&#39;, &#39;d&#39;, &#39;e&#39;]
</code></pre>
<p><strong>Params</strong></p>
<pre><code class="lang-js">range(start, stop, step, options, fn);
</code></pre>
<ul>
...
<pre><code class="lang-js">range(1, 3)
//=&gt; [&#39;1&#39;, &#39;2&#39;, &#39;3&#39;]
...
<h3 id="invalid-ranges">Invalid ranges</h3>
<p>When an invalid range is passed, <code>null</code> is returned. </p>
<pre><code class="lang-js">range(&#39;1.1&#39;, &#39;2&#39;);
//=&gt; null
...
<pre><code class="lang-js">range(&#39;a&#39;, &#39;e&#39;, function (val, isNumber, pad, i) {
  if (!isNumber) {
...
<pre><code class="lang-js">range(&#39;a&#39;, &#39;z&#39;, SPECIAL_CHARACTER_HERE);
</code></pre>
...
<p><strong>Examples:</strong></p>
<pre><code class="lang-js">range(&#39;a&#39;, 3, &#39;+&#39;);
//=&gt; [&#39;a&#39;, &#39;a&#39;, &#39;a&#39;]

range(&#39;abc&#39;, 2, &#39;+&#39;);
//=&gt; [&#39;abc&#39;, &#39;abc&#39;]
</code></pre>
<h4 id="pipe-and-tilde">pipe and tilde</h4>
...
<p><strong>Examples:</strong></p>
<pre><code class="lang-js">range(&#39;a&#39;, &#39;c&#39;, &#39;|&#39;);
//=&gt; [&#39;(a|b|c)&#39;
...
<pre><code class="lang-js">range(&#39;a&#39;, &#39;z&#39;, &#39;~5&#39;);
...
<h4 id="angle-bracket">angle bracket</h4>
<p>Character: <em>(<code>&gt;</code>)</em></p>
<p>Joins all values in the returned array to a single value.</p>
<p><strong>Examples:</strong></p>
<pre><code class="lang-js">range(&#39;a&#39;, &#39;e&#39;, &#39;&gt;&#39;);
//=&gt; [&#39;abcde&#39;]
...
<h4 id="question-mark">question mark</h4>
<p>Character: <em>(<code>?</code>)</em></p>
...
<pre><code class="lang-js">range(&#39;A&#39;, 5, &#39;?&#39;);
//=&gt; [&#39;NSHAK&#39;]
</code></pre>
<p>Generate a 5-digit random number:</p>
<pre><code class="lang-js">range(&#39;0&#39;, 5, &#39;?&#39;);
//=&gt; [&#39;36583&#39;]
</code></pre>
<p>Generate a 10-character alpha-numeric string:</p>
<pre><code class="lang-js">range(&#39;A0&#39;, 10, &#39;?&#39;);
//=&gt; [&#39;5YJD60VQNN&#39;]
</code></pre>
...
<h2 id="other-useful-libs">Other useful libs</h2>
<ul>
...
<pre><code class="lang-bash">npm i -d &amp;&amp; npm test
</code></pre>
...
<p>Copyright (c) 2014-2015 Jon Schlinkert<br>Released under the MIT license</p>
<hr>
