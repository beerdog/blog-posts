...
<pre><code class="lang-javascript">require(&#39;spdx-license-ids&#39;).forEach(function (id) {
...
<li><p>The license expression language, for describing simple and complex license terms, like <code>MIT</code> for MIT-licensed and <code>(GPL-2.0 OR Apache-2.0)</code> for dual-licensing under GPL 2.0 and Apache 2.0.  This package implements the license expression language.</p>
