...
<pre><code class="lang-javascript">var LRU = require(&quot;lru-cache&quot;)
  , options = { max: 500
...
away.</p>
<h2 id="keys-should-always-be-strings-or-numbers">Keys should always be Strings or Numbers</h2>
<p>Note: this module will print warnings to <code>console.error</code> if you use a
...
<pre><code class="lang-JavaScript">// Bad Example!  Dont&#39; do this!
var cache = LRU()
var a = {}
var b = {}
