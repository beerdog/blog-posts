...
<pre><code class="lang-javascript">var osenv = require(&#39;osenv&#39;)
var path = osenv.path()
var user = osenv.user()
// etc.
...
<h2 id="osenv-shell-">osenv.shell()</h2>
